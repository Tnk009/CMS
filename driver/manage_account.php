                ...
                <div class="container-fluid">
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" name="driver_contact" id="driver_contact" placeholder="Enter Contact Number" class="form-control form-control-sm form-control-border" required value="<?= isset($driver_contact) ? $driver_contact : "" ?>">
                        ...
                        <div class="row">
                            ...
                            <textarea name="driver_address" id="driver_address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Plot Number, Area, District"><?= isset($driver_address) ? $driver_address : "" ?></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
